...
Version  : 0.5.0
Release  : 22
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/tzdb_0.5.0.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/tzdb_0.5.0.tar.gz
Summary  : Time Zone Database Information
Group    : Development/Tools
License  : MIT
Requires: R-tzdb-lib = %{version}-%{release}
Requires: R-tzdb-license = %{version}-%{release}
Requires: R-cpp11
...
%package dev
Summary: dev components for the R-tzdb package.
Group: Development
Requires: R-tzdb-lib = %{version}-%{release}
Provides: R-tzdb-devel = %{version}-%{release}
Requires: R-tzdb = %{version}-%{release}

%description dev
dev components for the R-tzdb package.
...
%package license
Summary: license components for the R-tzdb package.
Group: Default

%description license
license components for the R-tzdb package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742480420

%install
export SOURCE_DATE_EPOCH=1742480420
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/R-tzdb
cp %{_builddir}/tzdb/LICENSE.note %{buildroot}/usr/share/package-licenses/R-tzdb/f8569dce7c57233e8ab2950a00fb73062a1de9df || :
LANG=C.UTF-8
...
/usr/lib64/R/library/tzdb/tzdata/checknow.awk
...
/usr/lib64/R/library/tzdb/tzdata/zonenow.tab
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/tzdb/libs/tzdb.so
/V4/usr/lib64/R/library/tzdb/libs/tzdb.so
/usr/lib64/R/library/tzdb/libs/tzdb.so

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/R-tzdb/f8569dce7c57233e8ab2950a00fb73062a1de9df
